...
Professional push and branch strategy for ongoing delivery after `v0.1.3`.
...
- Latest stable cut is on `main`:
  - app version: `0.1.3`
  - tags: `v0.1.1-pre` (historical), `v0.1.1`, `v0.1.2`, and `v0.1.3`
...
3. Release intent is explicit:
   ...
   - version cut (`0.1.4`/`0.2.0`) with changelog + tag.
...
1. `docs: align release and handoff state for v0.1.3`
