...
```bash
docker build -f web/Dockerfile.same-origin -t ghcr.io/<your-org>/rocketchat-app-logs-viewer-web:<tag> .
docker push ghcr.io/<your-org>/rocketchat-app-logs-viewer-web:<tag>
```
